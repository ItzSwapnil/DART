...
def get_dark_style():
    ...
    return mpf.make_mpf_style(
        ...
        marketcolors=mpf.make_marketcolors(
            ...
            edge={'up': dark_style.get('up_color', 'green'), 'down': dark_style.get('down_color', 'red')},
            wick={'up': dark_style.get('up_color', 'green'), 'down': dark_style.get('down_color', 'red')},
            volume={'up': dark_style.get('up_color', 'green'), 'down': dark_style.get('down_color', 'red')},
            ohlc={'up': dark_style.get('up_color', 'green'), 'down': dark_style.get('down_color', 'red')}
        ),
...
def get_light_style():
    ...
    return mpf.make_mpf_style(
        ...
        marketcolors=mpf.make_marketcolors(
            ...
            edge={'up': light_style.get('up_color', 'green'), 'down': light_style.get('down_color', 'red')},
            wick={'up': light_style.get('up_color', 'green'), 'down': light_style.get('down_color', 'red')},
            volume={'up': light_style.get('up_color', 'green'), 'down': light_style.get('down_color', 'red')},
            ohlc={'up': light_style.get('up_color', 'green'), 'down': light_style.get('down_color', 'red')}
        ),
